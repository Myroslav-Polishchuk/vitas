...
function AboutMain() {
    ...
    const partnersCompany = <>
        ...
        <h5>Університети</h5>
        <p>Видавничо-інформаційна група «ВІТ-А-ПОЛ» співпрацює з основними профільними вищими навчальними закладами України у сфері охорони здоров'я вже понад 29 років. Роботи відомих учених, наукова діяльність кафедр та факультетів публікуються на сторінках наших журналів, що сприяє розвитку медичної науки, освіти та самоосвіти фахівців медичної галузі.</p>
        <ul>
